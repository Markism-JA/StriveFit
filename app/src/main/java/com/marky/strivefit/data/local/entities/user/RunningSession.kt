...
data class RunningSession(
    @PrimaryKey val id: Long,              // Unique session ID (e.g., generated or from Health Connect)
    val userId: Long,                      // Reference to user
    val startTime: Long,                   // Epoch millis - session start time
    val durationSeconds: Int,              // Total duration in seconds
    val distanceMeters: Float,             // Total distance covered (meters)
    val caloriesBurned: Int,               // Total calories burned
